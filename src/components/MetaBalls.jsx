...
const MetaBalls = ({
  ...
  useEffect(() => {
    ...
    // Set pointerInside to true initially since it's tracking globally
    pointerInside = true;
  ...
  return <div ref={containerRef} className={`metaballs-container ${className}`} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'auto' }} />;
};
